...
TEST_F(AesAeTest,GCM_encDecVerify_128bit_ForAllTagSize)
{
	generateKey(128/*keySize*/);

	int tagSize[]={12,13,14,15,16}; //in bytes, TEE Internal Core API Specification p.161
...
TEST_F(AesAeTest,GCM_encDecVerify_192bit_ForAllTagSize)
{
...
TEST_F(AesAeTest,GCM_encDecVerify_256bit_ForAllTagSize)
{
	generateKey(256/*keySize*/);
